...
fn help() {
    ...
    command_macros::command! {
        {env.bin()} --config (env.config_path()) help apply-snapshot
    }
    .assert()
    .success()
    .stderr("")
    .stdout(indoc::indoc! {"
        mima-apply-snapshot 0.13.0
        Apply snapshot
...
fn happy_path_with_aliases() {
    ...
    command_macros::command! {
        {env.bin()} --config (env.config_path()) apply zero root
    }
    .assert()
    .success()
    .stdout("")
    ...
    command_macros::command! {
        {env.bin()} --config (env.config_path()) restore zero root
    }
    .assert()
    .success()
    .stdout("")
    ...
    command_macros::command! {
        {env.bin()} --config (env.config_path()) revert zero root
    }
    .assert()
    .success()
    .stdout("")
    ...
    command_macros::command! {
        {env.bin()} --config (env.config_path()) switch zero root
    }
    .assert()
    .success()
    .stdout("")
...
fn remote_happy_path() {
    ...
    command_macros::command! {
        {env.bin()} --config (env.config_path()) --host example.com apply-snapshot zero root
    }
    .assert()
    .success()
    .stdout("")
    ...
    env.assert_history(indoc::formatdoc! {"
        ...
        ssh -o BatchMode=yes -o ConnectTimeout=1 -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null root@example.com qemu-img snapshot -aroot {sda_path}
    "});
}
...
fn unknown_snapshot_failure() {
    ...
    command_macros::command! {
        {env.bin()} --config (env.config_path()) apply-snapshot zero dev
    }
    .assert()
    .failure()
    .stdout("")
...
fn uncommon_snapshot_failure() {
    ...
    command_macros::command! {
        {env.bin()} --config (env.config_path()) apply-snapshot zero centos7
    }
    .assert()
    .failure()
    .stdout("")
...
fn no_arguments() {
    ...
    command_macros::command! {
        {env.bin()} --config (env.config_path()) apply-snapshot
    }
    .assert()
    .failure()
    .stdout("")
...
fn one_argument() {
    ...
    command_macros::command! {
        {env.bin()} --config (env.config_path()) apply-snapshot one
    }
    .assert()
    .failure()
    .stdout("")
...
fn more_than_two_arguments() {
    ...
    command_macros::command! {
        {env.bin()} --config (env.config_path()) apply-snapshot one two three
    }
    .assert()
    .failure()
    .stdout("")
